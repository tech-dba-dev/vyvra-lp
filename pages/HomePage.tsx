...
const PRODUCTS: Product[] = [
  { id: 1, name: "Athletic Long Sleeve Top", image: "/Athletic long sleeve top.webp" },
  { id: 2, name: "Classic Motion Shorts", image: "/Classic Motion shorts.webp" },
  { id: 3, name: "Core Flow Legging", image: "/Core flow legging.webp" },
  { id: 4, name: "Edge Bra", image: "/Edge bra.webp" },
  { id: 5, name: "Elevate-V Legging", image: "/Elevate-V legging.webp" },
  { id: 6, name: "Flow Dress", image: "/Flow dress.webp" },
  { id: 7, name: "Layer Tee", image: "/Layer tee.webp" },
  { id: 8, name: "Pulse Bra", image: "/Pulse bra.webp" }
];
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      <div
        ...
        style={{ backgroundImage: `url('/imagehero.webp')` }}
      >
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-12 gap-16 items-center">
        <div className="md:col-span-7 text-left z-10">
          ...
          <div className="mt-8 mb-6">
            ...
            <h3
              onClick={onJoin}
              className="font-sans text-6xl md:text-8xl text-transparent bg-clip-text bg-gradient-to-b from-white to-white/60 font-semibold leading-none cursor-pointer hover:from-brand-accent hover:to-brand-accent/60 transition-all italic"
            >
              Become <br /> a Member
            </h3>
          </div>
      ...
      <div className="max-w-2xl mx-auto text-center">
        <div className="flex flex-col items-center gap-6 text-xs text-white/40 uppercase tracking-widest">
          <div className="flex gap-6">
            <a
              href="https://www.instagram.com/vyvraofficial"
              target="_blank"
            ...
            <a
              href="https://www.tiktok.com/@vyvraofficial"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white/40 hover:text-white transition-colors"
            >
          ...
          <p>&copy; {new Date().getFullYear()} VYVRA</p>
        </div>
      </div>
    </footer>
  );
